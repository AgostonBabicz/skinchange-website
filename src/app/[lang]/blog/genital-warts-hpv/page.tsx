...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return isDa
    ? {
        ...
        alternates: {
          canonical: 'https://www.skinchange.dk/da/blog/genital-warts-hpv',
          languages: {
            'x-default': 'https://www.skinchange.dk/da/blog/genital-warts-hpv',
            da: 'https://www.skinchange.dk/da/blog/genital-warts-hpv',
            en: 'https://www.skinchange.dk/en/blog/genital-warts-hpv',
          },
        },
      }
    : {
        ...
        alternates: {
          canonical: 'https://www.skinchange.dk/en/blog/genital-warts-hpv',
          languages: {
            'x-default': 'https://www.skinchange.dk/da/blog/genital-warts-hpv',
            da: 'https://www.skinchange.dk/da/blog/genital-warts-hpv',
            en: 'https://www.skinchange.dk/en/blog/genital-warts-hpv',
...
export default function GenitalWartsPage({ params: { lang } }: PageProps) {
  ...
  const articleSchema = {
    ...
    image: '/blog-genital-warts-hpv.jpg',
        ...
        <article className="pt-32 pb-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="rounded-2xl overflow-hidden mb-10 aspect-[16/7] relative bg-gradient-to-br from-[#304ffe] to-[#1a237e]">
              ...
              <img
                src="/blog-genital-warts-hpv.jpg"
                alt={isDa ? 'Kønsvorter – HPV-relaterede hudforandringer' : 'Genital warts – HPV-related skin changes'}
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p>
                {isDa
                  ? 'HPV kan overføres selv når en inficeret person ikke har synlige vorter. Kondomer reducerer risikoen, men beskytter ikke fuldt, da vorter kan sidde på områder der ikke dækkes. HPV kan også overføres fra mor til barn under fødslen, hvilket dog er sjældent.'
                  : 'HPV can be transmitted even when an infected person has no visible warts. Condoms reduce the risk but do not provide full protection, as warts can occur on areas not covered. HPV can also be transmitted from mother to child during childbirth, which is however rare.'}
              </p>
              ...
              <p>
                {isDa
                  ? 'Hos kvinder optræder vorterne typisk på skamlæberne (labia), i skeden, på livmoderhalsen eller omkring anus. Hos mænd ses de oftest på penishovedet, forhuden, pungen eller omkring anus.'
                  : 'In women, warts typically appear on the labia, inside the vagina, on the cervix or around the anus. In men, they are most often seen on the glans of the penis, foreskin, scrotum or around the anus.'}
              </p>
              <p>
                {isDa
              ...
              <ul>
                <li>
                  ...
                  {isDa
                    ? ': En creme der stimulerer immunforsvaret til at bekæmpe HPV. Påføres hjemme.'
                    : ': A cream that stimulates the immune system to fight HPV. Applied at home.'}
                </li>
                <li>
                  <strong>{isDa ? 'Podophyllotoxin' : 'Podophyllotoxin'}</strong>
                  {isDa
                    ? ': Opløsning eller creme der ødelægger vorternevævet. Anvendes i korte perioder.'
                    : ': Solution or cream that destroys wart tissue. Used in short periods.'}
                </li>
                <li>
                  <strong>{isDa ? 'Sinecatechiner (Veregen)' : 'Sinecatechins (Veregen)'}</strong>
                  {isDa
                    ? ': En grøn te-ekstrakt creme til behandling af kønsvorter.'
                    : ': A green tea extract cream for treating genital warts.'}
                </li>
              </ul>
              ...
              <ul>
                <li>
                  ...
                  {isDa
                    ? ': Frysning af vorterne med flydende kvælstof. Hurtig og effektiv behandling.'
                    : ': Freezing the warts with liquid nitrogen. Quick and effective treatment.'}
                </li>
                <li>
                ...
                <li>
                  ...
                  {isDa
                    ? ': Brug af laserlys til at ødelægge vorterne. Anvendes ved større eller svært tilgængelige vorter.'
                    : ': Using laser light to destroy the warts. Used for larger or hard-to-reach warts.'}
                </li>
                <li>
                  <strong>{isDa ? 'Elektrokirurgi' : 'Electrosurgery'}</strong>
                  {isDa
                    ? ': Brug af elektrisk strøm til at brænde vorterne væk.'
                    : ': Using electrical current to burn the warts away.'}
                </li>
              </ul>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p>
                    {isDa
                      ? 'Kønsvorter kan normalt identificeres ved visuel undersøgelse. Din læge kan bruge et forstørrelsessinstrument (kolposkop) til at undersøge vagina og livmoderhals. En biopsi kan tages ved usikker diagnose.'
                      : 'Genital warts can usually be identified by visual examination. Your doctor may use a magnification instrument (colposcope) to examine the vagina and cervix. A biopsy may be taken if the diagnosis is uncertain.'}
                  </p>
                </div>
                <div>
                  <h3 className="font-bold text-lg text-[#1a237e] mb-2">
                  ...
                  <p>
                    {isDa
                      ? 'Den bedste forebyggelse er HPV-vaccination (Gardasil 9), som beskytter mod 9 HPV-typer, herunder dem der forårsager kønsvorter og kræft. Konsistent kondombrug reducerer også risikoen, men fjerner den ikke helt.'
                      : 'The best prevention is HPV vaccination (Gardasil 9), which protects against 9 HPV types, including those that cause genital warts and cancer. Consistent condom use also reduces the risk, but does not eliminate it entirely.'}
                  </p>
                </div>
                <div>
                  <h3 className="font-bold text-lg text-[#1a237e] mb-2">
                  ...
                  <p>
                    {isDa
                      ? 'Ja, kønsvorter kan komme tilbage, da HPV ikke kan helbredes, kun behandles. Virus kan forblive i kroppen i latent form, og vorter kan gendannes når immunsystemet er svækket.'
                      : 'Yes, genital warts can come back because HPV cannot be cured, only treated. The virus can remain in the body in a latent form, and warts can recur when the immune system is weakened.'}
                  </p>
                </div>
              </div>
              ...
              <div className="bg-[#1a237e] text-white rounded-2xl p-8 my-12">
                ...
                <p className="mb-6">
                  {isDa
                    ? 'Hvis du har mistanke om kønsvorter eller HPV, kan du få en personlig vurdering fra en certificeret hudlæge via SKIND-appen — diskret og uden ventetid.'
                    : 'If you suspect genital warts or HPV, you can get a personal assessment from a certified dermatologist via the SKIND app — discreetly and without a waiting list.'}
                </p>
