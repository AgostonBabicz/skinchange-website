...
export default function PartnersSection({ lang }: PartnersSectionProps) {
  ...
  const partners = [
    { src: '/Partner_1.png', alt: 'Teknologisk Institut', width: 180, height: 42, bright: false },
    { src: '/Partner_2.svg', alt: 'Privathospitalet Mølholm', width: 160, height: 42, bright: false },
    { src: '/Partner_Kollab.svg', alt: 'KOLLAB', width: 140, height: 25, bright: true },
    { src: '/Partner_New.png', alt: 'NEW&', width: 120, height: 40, bright: false },
    { src: '/Partner_4.svg', alt: 'C2IT Greenhouse', width: 160, height: 41, bright: true },
  ];
          ...
          <div className="flex gap-20 animate-scroll-left py-4">
            {[...partners, ...partners, ...partners].map((partner, index) => (
              <img
                ...
                className={`object-contain flex-shrink-0 ${partner.bright ? 'brightness-0 invert' : ''}`}
              />
            ))}
          </div>
        </div>
