...
William Nielsen Prisen`,
    ...
    diseases: {
      ...
      items: [
        { name: 'Hudkræft', desc: 'Mistanke om forandringer', slug: 'melanoma' },
        { name: 'Akne', desc: 'Uren hud og bumser', slug: 'acne' },
        { name: 'Eksem', desc: 'Irriteret og kløende hud', slug: 'eczema-atopic-dermatitis' },
        { name: 'Psoriasis', desc: 'Skællende hudpletter', slug: 'psoriasis' },
        { name: 'Rosacea', desc: 'Rødme og blodkar', slug: 'rosacea' },
        { name: 'Skæl', desc: 'Flassende hovedbund', slug: 'seborrheic-dermatitis' },
        { name: 'Kønsvorter', desc: 'HPV-relaterede forandringer', slug: 'genital-warts-hpv' },
        { name: 'Forkølelsessår', desc: 'Herpes simplex behandling', slug: 'herpes-simplex-virus' },
      ],
    },
    userGuide: {
...
William Nielsen Prize`,
    ...
    diseases: {
      ...
      items: [
        { name: 'Skin Cancer', desc: 'Suspicious changes', slug: 'melanoma' },
        { name: 'Acne', desc: 'Blemishes and pimples', slug: 'acne' },
        { name: 'Eczema', desc: 'Irritated and itchy skin', slug: 'eczema-atopic-dermatitis' },
        { name: 'Psoriasis', desc: 'Scaly skin patches', slug: 'psoriasis' },
        { name: 'Rosacea', desc: 'Redness and visible blood vessels', slug: 'rosacea' },
        { name: 'Dandruff', desc: 'Flaky scalp', slug: 'seborrheic-dermatitis' },
        { name: 'Genital Warts', desc: 'HPV-related changes', slug: 'genital-warts-hpv' },
        { name: 'Cold Sores', desc: 'Herpes simplex treatment', slug: 'herpes-simplex-virus' },
      ],
    },
    userGuide: {
